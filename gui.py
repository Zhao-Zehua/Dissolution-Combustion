...
class StringEntriesWidget(ttk.Frame):
    ...
    class CachedStringEntryWidget(ttk.Frame):
        def __init__(self, master, name, default=None, text=None, **kwargs):
            def bind_return():
...
class SpinEntriesWidget(ttk.Frame):
    ...
    class SpinEntry(ttk.Frame):
        ...
        def set_from_to(self,_from,to):
            self.entry.config(from_=_from,to=to)
    ...
    def set_var(self,name,var):
        self.entries_table[name].set_var(var)
...
class Screen1_Data(Screen):
    ...
    def __init__(self):
        ...
        self.arrangeLeft()
        self.addTableBox(["times(s)","Delta_T(K)"],[50,50],0.35)
        self.addInfoLabel()
        self.addEntries()
        self.addTextBox(15)
    ...
    def initShortCut(self):
        DATA_CONFIG["window"].bind("<Control-Shift-r>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-Shift-R>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-d>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-D>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-c>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-C>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-q>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-Q>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-r>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-R>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-w>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-W>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-e>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-E>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-s>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-S>", self.button_shortcut)
...
class Screen2_Dissolution(Screen):
    ...
    def __init__(self):
        ...
        self.arrangeLeft()
        self.addTableBox(["index","times(s)","Delta_T(K)"],[25,50,50],0.15)
        self.addInfoLabel()
        self.addEntries()
        self.addTextBox(15)
        self.addPlotBox(65,"$t$ (s)","$\Delta T$ (K)")
    ...
    def addEntries(self):
        ...
        self.button_integrate.config(state="disabled")
    def initShortCut(self):
        DATA_CONFIG["window"].bind("<Control-f>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-F>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-s>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-S>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-z>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-Z>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-d>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-D>", self.button_shortcut)
...
class Screen3_Combustion(Screen):
    ...
    def initShortCut(self):
        ...
        DATA_CONFIG["window"].bind("<Control-d>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Control-D>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-E>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-e>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-S>", self.button_shortcut)
        DATA_CONFIG["window"].bind("<Alt-s>", self.button_shortcut)
    def set_entry_state(self):
        if DATA_CONFIG["combustion_mode"].get() == "constant":
